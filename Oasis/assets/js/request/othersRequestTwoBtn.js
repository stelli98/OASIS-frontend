...
$(document).ready(function () {
    ...
    function loadAssetList(currPage) {
        $.ajax({
            type: 'GET',
            url: path + '/api/requests/list/' + username + '/others?status=Requested&page=' + currPage,
            ...
            success: function (data) {
                ...
                for (var index = 0; index < data.value.requests.length; index++) {
                    ...
                    <div class='table-content table-content-request-others-two-btn-lastUpdate'>${data.value.requests[index].request.updatedDate}</div>
